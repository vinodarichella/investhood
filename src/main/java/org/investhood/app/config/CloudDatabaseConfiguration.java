package org.investhood.app.config;
...
@Configuration
@EnableMongoRepositories("org.investhood.app.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("org.investhood.app.config.dbmigrations");
